...
<div class="bgded overlay" style="background-image:url('{{ url('../images/demo/backgrounds/01.png') }}');"> 
  ...
  <nav id="mainav" class="fl_right">
     <ul class="clear">
     <li class="active"><a href="{!! url('tms/index1') !!}">Home</a></li>       <li><a href="{!! url('tms/gallery') !!}">Gallery</a></li>
 ...
 &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp 
          ...
          <li class=""> 
   <a style="display: inline;" ="" href="{{ route('logout') }}"
   ...
   &nbsp&nbsp
    ...
    <li>
 <a style="display: inline;" href="{!! url('tms/editProfile',Auth::user()->id) !!}"  >
       {{ __('Edit') }}
       </a>
                            </li>  
      <li class="">
    ...
    <ul class="nospace group services">
      ...
      <li class="one_quarter">
        <article><a href="#"><i class="fa fa-3x fa-ravelry"></i></a>
         <h6 class="heading font-x1"><a href="#">Places to visit</a></h6>      </article>
      </li>
    </ul>
  </section>
</div>
